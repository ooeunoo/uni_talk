...
final CustomTheme lightThemeData = CustomTheme(
    ...
    chatRoomAppBarIcon: const IconThemeData(color: Color(0xFF000000)),
    chatRoomAppBarTitle: const TextStyle(
...
final CustomTheme darkThemeData = CustomTheme(
    ...
    chatRoomAppBarIcon: const IconThemeData(color: Color(0xFFFFFFFF)),
    chatRoomAppBarTitle: const TextStyle(
...
CustomTheme getThemeData(Brightness brightness) {
