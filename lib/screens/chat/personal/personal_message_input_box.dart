...
class PersonalMessageInputBox extends StatelessWidget {
  final TextEditingController msgController;
  final Future<void> Function(String msg) startConversation;
  final bool enable;

  const PersonalMessageInputBox(
      {super.key,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            IconButton(
              color: Colors.blue,
              onPressed: () => startConversation(msgController.text),
              icon: const Icon(
