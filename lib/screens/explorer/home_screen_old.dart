...
//   VirtualUserProvider virtualUserProvider = VirtualUserProvider();
//   // late Future<List<>> _topSelectedRoleChats;
//   List<VirtualUser> virtualUsers = [];
//   // Map<RoleChatCategory, List<VirtualUser>> virtualUsers = {};
...
//   Future<void> _handleRoleChatItemSelected(VirtualUser role) async {
